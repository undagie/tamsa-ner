...
OUTPUT_DIR = _ROOT / "outputs" / "experiment_mbert_bilstm"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

BEST_MODEL_PATH = OUTPUT_DIR / "mbert-bilstm-crf-best.pt"
...
def main():
    ...
    train_dataset = NERTransformerDataset(train_data, tag_to_ix, tokenizer)
    dev_dataset = NERTransformerDataset(dev_data, tag_to_ix, tokenizer)
    ...
    print("Initializing mBERT-BiLSTM-CRF model...")
