...
OUTPUT_DIR = _ROOT / "outputs" / "evaluation_nerui_mbert_bilstm"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

ORIGINAL_EXPERIMENT_DIR = _ROOT / "outputs" / "experiment_mbert_bilstm"
BEST_MODEL_PATH = ORIGINAL_EXPERIMENT_DIR / "mbert-bilstm-crf-best.pt"
...
print(f"Model: mBERT + BiLSTM-CRF | Device: {DEVICE}")
