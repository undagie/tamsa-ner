...
OUTPUT_DIR = _ROOT / "outputs" / "evaluation_nerui_indobert"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

ORIGINAL_EXPERIMENT_DIR = _ROOT / "outputs" / "experiment_indobert"
BEST_MODEL_PATH = ORIGINAL_EXPERIMENT_DIR / "indobert-crf-best.pt"
